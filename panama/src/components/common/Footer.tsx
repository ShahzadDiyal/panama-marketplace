      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs mb-6">
              Your trusted platform for premium sourcing, verified suppliers, and exclusive deals. Building business bridges globally.
            </p>
            {/* Socials */}
            <div className="flex items-center gap-3">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-amber-400 hover:bg-amber-400/10 hover:border-amber-400/30 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} Paname. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            ...
            <Link to="/" className="text-slate-500 text-sm hover:text-slate-300 transition-colors">Cookies</Link>
          </div>
        </div>
